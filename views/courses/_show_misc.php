...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->seminar_number) ?></div>
  </div><!-- /grid-a -->
<?
}
// teilnehmer
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->participants) ?></div>
  </div><!-- /grid-a -->
<?
}
// Voraussetzungen
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->requirements) ?></div>
  </div><!-- /grid-a -->
<?
}
//Leistungsnachweis
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->leistungsnachweis) ?></div>
  </div><!-- /grid-a -->
<?
}
// ects
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->ects) ?> LP</div>
  </div><!-- /grid-a -->
<?
}
// Lernorganisation
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->orga) ?></div>
  </div><!-- /grid-a -->
<?
}
// Sonstiges
...
?>
  <div class="ui-grid-a a_bit_smaller_text">
    ...
    <div class="ui-block-b"><?= $this->out($course->Sonstiges) ?></div>
  </div><!-- /grid-a -->
<?
}
?>
